 ...
 */
/**
 * Copyright (C) 2018  Valter Martinek (email : martinek@freevision.sk)
 *
 ...
 */
define( 'WOWPROGRESS_VERSION', '1.21.0' );
...
class wowprogress_widget extends WP_Widget {
    ...
    function register_plugin_scripts() {
        ...
        wp_register_script(WOWPROGRESS_PLUGIN_SLUG, WOWPROGRESS_PLUGIN_URL . WOWPROGRESS_PLUGIN_SLUG . '.js', array(), WOWPROGRESS_VERSION);
